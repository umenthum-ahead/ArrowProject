...
class MemoryManager_API:
    ...
    from Arrow.Tool.memory_management.memory_operand import Memory as _Memory
    from Arrow.Tool.memory_management.memory_block import MemoryBlock as _MemoryBlock
    from Arrow.Tool.memory_management.memlayout.segment import MemorySegment as _MemorySegment
    ...
    def MemoryBlock(
            ...
            _is_stack: bool = False, # used for the program stack
    ) -> _MemoryBlock:
        """
        ...
        return _MemoryBlock(byte_size=byte_size, name=name, address=address, memory_type=memory_type, shared=shared, alignment=alignment, init_value=init_value, init_value_byte_representation=init_value_byte_representation, _use_name_as_unique_label=_use_name_as_unique_label, _is_stack=_is_stack, cross_core=cross_core)
    ...
    def MemorySegment(
        ...
        return current_state.get_segment_manager().allocate_memory_segment(name=name, byte_size=byte_size, memory_type=memory_type)
